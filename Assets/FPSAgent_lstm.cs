...
public static class MyF_lstm {
    public static bool RandomBool () {
        return Random.Range (0, 2) == 0;
    }
}

public class FPSAgent_lstm : Agent {
    ...
    //     // t_pos.y = t_pos.y + 1.375f;
    //     // Debug.Log (DistanceToLine (ray, t_pos));
    ...
    public override void CollectObservations (VectorSensor sensor) {
        ...
        Vector3 t_pos = target.position;
        t_pos.y = t_pos.y + 1.375f;
        sensor.AddObservation (DistanceToLine (ray, t_pos));
    }
